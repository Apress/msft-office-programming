...
.langFont {
	FONT-FAMILY: Verdana
			...
			<body>
				...
				<div>
					<font size="1"><span class="xdTextBox" hideFocus="1" title="First name" accessKey="F" tabIndex="0" xd:CtrlId="CTRL1" xd:xctname="PlainText" xd:binding="my:txtFirstName" style="FONT-SIZE: x-small; WIDTH: 172px; HEIGHT: 20px">
				...
				<div>
					<font size="1"><span class="xdTextBox" hideFocus="1" title="Last name" accessKey="L" tabIndex="0" xd:CtrlId="CTRL2" xd:xctname="PlainText" xd:binding="my:txtLastName" style="FONT-SIZE: x-small; WIDTH: 172px; HEIGHT: 20px">
				...
				<div><span class="xdTextBox" hideFocus="1" title="Street address" accessKey="S" tabIndex="0" xd:CtrlId="CTRL3" xd:xctname="PlainText" xd:binding="my:txtStreet" style="FONT-SIZE: x-small; WIDTH: 172px; HEIGHT: 20px">
						<xsl:value-of select="my:txtStreet"/>
					</span>
					<br/>
					<font size="1">
						<u>C</u>ity</font>
				...
				<div>
					<font size="1"><span class="xdTextBox" hideFocus="1" title="City" accessKey="C" tabIndex="0" xd:CtrlId="CTRL4" xd:xctname="PlainText" xd:binding="my:txtCity" style="FONT-SIZE: x-small; WIDTH: 172px; HEIGHT: 20px">
				...
				<div>
					<font size="1"><select class="xdComboBox xdBehavior_Select" title="State" accessKey="t" size="1" tabIndex="0" xd:CtrlId="CTRL5" xd:xctname="DropDown" xd:binding="my:cboState" xd:boundProp="value" style="FONT-SIZE: x-small; WIDTH: 62px">
						...
						</select>          </font><span class="xdTextBox" hideFocus="1" title="Zip code" accessKey="Z" tabIndex="0" xd:CtrlId="CTRL6" xd:xctname="PlainText" xd:binding="my:txtZip" style="FONT-SIZE: x-small; WIDTH: 68px; HEIGHT: 20px">
